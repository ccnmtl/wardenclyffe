...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CollectionWorkflow'
        db.create_table('main_collectionworkflow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Collection'])),
            ('workflow', self.gf('django_extensions.db.fields.UUIDField')(max_length=36, blank=True)),
            ('label', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
        ))
        db.send_create_signal('main', ['CollectionWorkflow'])


    def backwards(self, orm):
        
        # Deleting model 'CollectionWorkflow'
        db.delete_table('main_collectionworkflow')
    ...
    models = {
        ...
        'main.collectionworkflow': {
            ...
            'workflow': ('django_extensions.db.fields.UUIDField', [], {'max_length': '36', 'blank': 'True'})
        },
        'main.file': {
