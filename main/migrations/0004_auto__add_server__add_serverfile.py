...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_server', (
            ...
            ('credentials', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('base_dir', self.gf('django.db.models.fields.CharField')(default='/', max_length=256)),
            ('base_url', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('server_type', self.gf('django.db.models.fields.CharField')(default='sftp', max_length=256)),
        ))
        db.send_create_signal('main', ['Server'])

        # Adding model 'ServerFile'
        db.create_table('main_serverfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('main', ['ServerFile'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ServerFile'
        db.delete_table('main_serverfile')
