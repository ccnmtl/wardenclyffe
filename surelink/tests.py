...
class PublicFLVDefaultPosterTestCase(unittest.TestCase):
    ...
    def testBasicEmbed(self):
        self.assertEquals(self.surelink.basic_embed(),
                          """<script type="text/javascript" src="http://ccnmtl.columbia.edu/stream/jsembed?player=v4&file=test/test_stream.flv&width=480&height=360&poster=http://ccnmtl.columbia.edu/broadcast/test/test_stream.jpg&protection=74464d1a6c82afe0f73ab5c59a2c5e25ab470857"></script>""")

    def testIFrameEmbed(self):
        self.assertEquals(self.surelink.iframe_embed(),
                          """<iframe width="480" height="384" src="https://surelink.ccnmtl.columbia.edu/video/?player=v4&file=test/test_stream.flv&width=480&height=360&poster=http://ccnmtl.columbia.edu/broadcast/test/test_stream.jpg&protection=74464d1a6c82afe0f73ab5c59a2c5e25ab470857" />""")
...
class WindMP4TestCase(unittest.TestCase):
    ...
    def testBasicEmbed(self):
        self.assertEquals(self.surelink.basic_embed(),
                          """<script type="text/javascript" src="http://ccnmtl.columbia.edu/stream/jsembed?player=v4&file=test/test_clip.mp4&width=480&height=360&poster=http://ccnmtl.columbia.edu/broadcast/posters/vidthumb_480x360.jpg&authtype=wind"></script>""")

    def testIFrameEmbed(self):
        self.assertEquals(self.surelink.iframe_embed(),
                          """<iframe width="480" height="384" src="https://surelink.ccnmtl.columbia.edu/video/?player=v4&file=test/test_clip.mp4&width=480&height=360&poster=http://ccnmtl.columbia.edu/broadcast/posters/vidthumb_480x360.jpg&authtype=wind" />""")
    ...
    def testMDPEmbed(self):
        self.assertEquals(self.surelink.mdp_embed(),
                          """[flv]http://ccnmtl.columbia.edu/stream/flv/5916f0fe8ab583c47adf39fbe3a80086b7122994/OPTIONS/test/test_clip.mp4[w]480[h]360[flv]""")
