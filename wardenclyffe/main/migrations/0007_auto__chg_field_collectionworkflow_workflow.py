...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CollectionWorkflow.workflow'
        db.alter_column('main_collectionworkflow', 'workflow', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'CollectionWorkflow.workflow'
        db.alter_column('main_collectionworkflow', 'workflow', self.gf('django_extensions.db.fields.UUIDField')(max_length=36))
